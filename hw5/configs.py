...
# experiment params
flags.DEFINE_string("prefix", "exe_v1", "Nickname for the experiment [default]")
...
# system variations
flags.DEFINE_boolean("apply_batch_norm", True, "Whether to apply batch normalization [False]")
...
flags.DEFINE_integer("val_step", 5000, "Interval for validation [5000]")
